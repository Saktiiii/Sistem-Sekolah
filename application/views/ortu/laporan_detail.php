          ...
          <div class="col-lg-12">
            <div class="card shadow-lg border-0 rounded-xl p-0">
              <div class="card-header bg-indigo-600 text-white py-3 rounded-t-xl">
                <h3 class="mb-0 fw-bold text-center"><i class="bi bi-person-badge-fill me-2"></i> Detail Data Siswa</h3>
              </div>
              <div class="card-body p-4 p-md-5">

                <div class="mb-4 pb-3 border-bottom border-indigo-100">
                  <h4 class="text-2xl font-bold text-indigo-800 mb-1"><?= htmlspecialchars($siswa->nama) ?></h4>
                  <p class="text-gray-500 mb-0">NIS: <span
                      class="fw-semibold me-3"><?= htmlspecialchars($siswa->nis) ?></span> | Kelas: <span
                      class="badge bg-success-subtle text-success-emphasis fw-bolder fs-6"><?= htmlspecialchars($siswa->kelas_id) ?></span>
                  </p>
                </div>

                <h5 class="fw-semibold text-gray-700 mb-3 mt-4"><i class="bi bi-info-circle me-2 text-indigo-500"></i>
                ...
                <div class="row g-3 mb-5">
                  <div class="col-md-6">
                    <ul class="list-group list-group-flush border rounded-lg shadow-sm">
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center py-3">
                        ...
                        <span class="fw-medium"><?= htmlspecialchars($siswa->tanggal_lahir) ?></span>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-center py-3 bg-light">
                  ...
                  <div class="col-md-6">
                    <div class="p-3 bg-gray-50 border rounded-lg h-full">
                      <strong class="text-muted d-block mb-1"><i class="bi bi-geo-alt me-1"></i> Alamat:</strong>
                      <p class="mb-0 text-gray-700 fst-italic text-sm"><?= htmlspecialchars($siswa->alamat) ?></p>
                    </div>
                  </div>
                </div>
                ...
                <h5 class="fw-semibold text-gray-700 mb-3"><i
                    class="bi bi-calendar-check-fill me-2 text-indigo-500"></i> Riwayat Presensi</h5>
                    ...
                    <tbody>
                      <?php if (!empty($siswa->presensi)): ?>
                        <?php foreach ($siswa->presensi as $p): ?>
                          <tr>
                            <td><i class="bi bi-calendar-event me-1 text-muted"></i> <?= htmlspecialchars($p->tanggal) ?>
                            </td>
                            <td class="text-center">
                              ...
                              <span class="badge <?= $status_class ?> fw-semibold p-2 rounded-pill">
                                <?= $status_text ?>
                              </span>
                            </td>
                            <td class="text-muted fst-italic text-sm"><?= htmlspecialchars($p->keterangan) ?></td>
                          </tr>
                        <?php endforeach; ?>
                      <?php else: ?>
                        <tr>
                          <td colspan="3" class="text-center text-muted fst-italic p-3">
                            <i class="bi bi-info-circle me-1"></i> Belum ada data presensi yang tercatat.
                          </td>
                        </tr>
                      <?php endif; ?>
                    </tbody>
