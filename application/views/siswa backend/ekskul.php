  ...
  <div class="row">
   ...
   <div class="col-md-2 sidebar">
        ...
        <ul class="nav flex-column">
          ...
          <li><a class="nav-link active" href="<?= site_url('Page/ekskul'); ?>">🏅 Ekskul</a></li>
    ...
    <div class="col-md-10 p-4">
      <div class="welcome-box">
        <h2><i class="bi bi-trophy-fill"></i> Data Ekstrakurikuler</h2>
        <p>Manajemen kegiatan ekstrakurikuler dan pembina.</p>
      </div>

      <table class="table table-bordered shadow-sm align-middle">
        <thead>
          <tr>
            <th>No</th><th>Nama Ekskul</th><th>Pembina</th><th>Hari Kegiatan</th><th>Jumlah Anggota</th><th>Aksi</th>
          </tr>
        </thead>
        <tbody>
          <tr><td>1</td><td>Pramuka</td><td>Bu Sinta</td><td>Jumat</td><td>35</td>
          <td><button class="btn btn-sm btn-primary">Edit</button> <button class="btn btn-sm btn-danger">Hapus</button></td></tr>
          <tr><td>2</td><td>Futsal</td><td>Pak Rudi</td><td>Sabtu</td><td>20</td>
          <td><button class="btn btn-sm btn-primary">Edit</button> <button class="btn btn-sm btn-danger">Hapus</button></td></tr>
        </tbody>
      </table>
    </div>
