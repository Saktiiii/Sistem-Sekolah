  ...
  <div class="row">
    ...
    <div class="col-md-10 p-4">
      <div class="welcome-box">
        <h2><i class="bi bi-chat-left-text-fill"></i> Layanan Konseling</h2>
        <p>Data hasil konseling siswa oleh guru BK.</p>
      </div>

      <table class="table table-bordered shadow-sm align-middle">
        <thead>
          <tr><th>No</th><th>Nama Siswa</th><th>Kelas</th><th>Masalah</th><th>Tanggal Konseling</th><th>Guru BK</th><th>Aksi</th></tr>
        </thead>
        <tbody>
          <tr><td>1</td><td>Salma Raihana</td><td>XI RPL A</td><td>Motivasi belajar menurun</td><td>01-09-2025</td><td>Bu Nita</td><td><button class="btn btn-sm btn-primary">Detail</button></td></tr>
          <tr><td>2</td><td>Andi Prasetyo</td><td>XI RPL B</td><td>Sering terlambat</td><td>03-09-2025</td><td>Pak Dodi</td><td><button class="btn btn-sm btn-primary">Detail</button></td></tr>
        </tbody>
      </table>
    </div>
  </div>
